...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6096550653:AAF7GPob4SlKxCKulQ7vQXsuDcxbe_FMfYE")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "23107450"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "f1c1221d77aacfb3189f7c940b41f9f3")
...
DB_NAME = os.environ.get("DATABASE_NAME", "videos")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001568871944"))
