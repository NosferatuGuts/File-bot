...
APP_ID = int(os.environ.get("APP_ID", "18296791"))
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://ryuuzainetwork:IGdesABI32IZWDOO@cluster0.yfthgbo.mongodb.net/?retryWrites=true&w=majority")
